...
- Полет в инверте - полет в перевернутом положении засчет инерции, данной коптеру перед переворотом
- S-Split - пол переворота ROLL'ом + полет в инверте над объектом + вылет под объектом половиной FLIP'а
